    ...
    return Scaffold(
        body: Column(
          ...
          children: [
            Row(
              children: [
                Expanded(child: Container(color: Colors.red,width: double.infinity,height: 20,)),
                Expanded(child: Container(color: Colors.yellowAccent,width: double.infinity,height: 20,)),
              ],
            ),
            WXText("这是使用WXText展示中间截断的字符串这是使用WXText展示中间截断的字符串这是使用WXText展示中间截断的字符串",),
            Text("这是使用Text展示中间截断的字符串这是使用WXText展示中间截断的字符串这是使用WXText展示中间截断的字符串",overflow: TextOverflow.ellipsis,),
            WXText("这是使用WXText展示中间截断的字符串",),
            WXText("WWWWWWWWWWWWWWWWW这是使用WXText展示中间截断的字符串lllllllllllllllllllll",),
            WXText("llllllllllllllllllllllllllllllllMMMMMMMMMMMMMMMMMMMMMMMMMM",),
            WXText("这是使用WXText展示中间截断的字符串dsgfalkgjlakjgldakjglkfagf",),
            WXText("aglkdagjklfalkda;lfgka;lgk;flakg;lfkg;lkdfsl",),
          ],
        )
    );
  }
